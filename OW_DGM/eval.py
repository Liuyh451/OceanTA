...
predictions = average_by_groups(predictions, group_size=24)
ground_truths = average_by_groups(ground_truths, group_size=24)
rmse_all_features(predictions, ground_truths)
