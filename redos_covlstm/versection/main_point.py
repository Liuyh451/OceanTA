# todo 用点进行训练 1.加载数据(done) 2.形状(done) 3.特征图大小
""""
...
# 划分验证集
test_sssa, _, _ = data_pre.read_col_data(data_dict, 's')
test_ssha, _, _ = data_pre.read_col_data(data_dict, 'zeta')
test_sswu, _, _ = data_pre.read_col_data(data_dict, 'u')
test_sswv, _, _ = data_pre.read_col_data(data_dict, 'v')
test_argo, label_test_argo, _ = data_pre.read_col_data(data_dict, 't')
...
from utils_point import cmip_dataset
