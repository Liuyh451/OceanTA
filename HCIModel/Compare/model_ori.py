...
def save_loss_with_increment(train_loss_list, folder_path='data/loss/proposed', base_filename='train_loss_list.npy'):
    # 检查文件夹是否存在，不存在则创建
...
class BrainAnalysisModule(nn.Module):
    def __init__(self, input_channels, output_channels, time_step):
        ...
        self.fc_output_channels = 8  # 设置输出通道数为 8
    ...
    def train(self, train_data, val_data):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_idx, (inputs, targets) in enumerate(train_loader):
                ...
                # 计算损失
                # print(final_output.shape, targets.shape)
